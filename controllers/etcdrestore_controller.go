...
// +kubebuilder:rbac:groups=devops.my.domain,resources=etcdrestores,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=devops.my.domain,resources=etcdrestores/status,verbs=get;update;patch
